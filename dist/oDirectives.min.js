...
angular.module("envoc.directives.datatables").controller("oTableCtrl",["$scope","$http","$filter","$rootScope","$timeout",function(t,e,a,r,n){function o(){var t=angular.copy(M);D.state.allSearch?(t=$(t,D.state.allSearch),D.state.iTotalDisplayRecords=t.length):D.state.iTotalDisplayRecords=M.length;var e=D.state.sortOrder.length>0;if(e){var a=D.state.sortOrder[0],r=D.state.sortObj[a]?"+":"-",n=r+a;t=C(t,n)}for(D.state.iTotalRecords=M.length,D.state.pageStartIdx=(D.state.currentPage-1)*D.state.linesPerPage;D.state.pageStartIdx>t.length;)D.state.currentPage--,v();D.data=A(j(t,D.state.pageStartIdx),D.state.linesPerPage),y()}function s(){A=a("limitTo"),$=a("filter"),j=a("startFrom"),C=a("orderBy"),M=I.dataSrc,o(),S(),r.$on("oTable::sorting",o),r.$on("oTable::filtering",o)}function i(){b(),r.$on("oTable::filtering",D.fetch)}function l(t){return e.post(I.dataSrcUrl,t)}function c(){return I.defaultSort.map(function(t){return{ColumnIndex:t[0],SortDirection:t[1],SearchTerm:t[2]||null}})}function u(){var t=D.state,e=angular.extend({},t.searchObj,t.sortObj),a={Skip:(t.currentPage-1)*t.linesPerPage,Take:t.linesPerPage,AllSearch:t.allSearch};return a.Columns=[],angular.forEach(e,function(e,r){var n=angular.isDefined(t.sortObj[r])?f(r):null,o=t.searchObj[r]||null,s=I.propertyMap[r];(n||o)&&a.Columns.push({ColumnIndex:s,SortDirection:n,SearchTerm:o})}),I.defaultSort.length&&!D.state.sortOrder.length&&(a.Columns=Array.prototype.concat.apply(a.Columns,c())),a}function d(t){return D.state.sortOrder.indexOf(t)>-1}function f(t){var e="";return d(t)&&(e=D.state.sortObj[t]?"asc":"desc"),e}function h(t){function e(t){function e(e,a){r[e]=t[a],I.propertyMap[e]=a}var r={};return a.forEach(e),r}I.propertyMap={};var a=t.sColumns.split(","),r=t.aaData.map(e);return r}function g(t){D.data=M=h(t.data),D.state.iTotalRecords=t.data.iTotalRecords,D.state.iTotalDisplayRecords=t.data.iTotalDisplayRecords,v(),y(),D.loading=!1}function p(){alert("Error fetching data")}function S(){t.$watch(P,o),t.$watch(T,o),t.$watch(O,o),t.$watchCollection(m,o)}function b(){I.throttle>300&&(D.fetch=x(D.fetch,I.throttle)),t.$watch(u,D.fetch,!0)}function P(){return D.state.currentPage}function T(){return D.state.linesPerPage}function O(){return D.state.allSearch}function m(){return M}function v(){D.state.pageStartIdx=(D.state.currentPage-1)*D.state.linesPerPage}function y(){D.state.pageStopIdx=D.state.pageStartIdx+D.data.length}function x(t,e,a){e||(e=250);var r,n;return function(){var o=a||this,s=+new Date,i=arguments;r&&r+e>s?(clearTimeout(n),n=setTimeout(function(){r=s,t.apply(o,i)},e)):(r=s,t.apply(o,i))}}var A,$,j,C,D=this,M=[],I={fetchMethod:null,linesPerPage:10,throttle:0,defaultSort:[]};this.api={refresh:function(){D.fetch(!0)}},this.init=function(t){if(angular.extend(I,t),D.paginationSettings=t.paginationSettings||{},!I.dataSrcUrl&&!I.dataSrc&&!I.fetchMethod)throw new Error("A data source is required");I.dataSrcUrl&&(I.fetchMethod=l),this.state={currentPage:1,linesPerPage:I.linesPerPage,iTotalRecords:0,iTotalDisplayRecords:0,allSearch:"",sortObj:{},sortOrder:[],searchObj:{}},I.dataSrc?s():i()},this.fetch=function(t){var e=u();I.getAdditionalParams&&(e=angular.extend(e,I.getAdditionalParams())),!t&I.fetchMethod.last&&angular.toJson(e)==I.fetchMethod.last||(D.loading=null,n(function(){null==D.loading&&(D.loading=!0)},500),I.fetchMethod(e).then(g,p),I.fetchMethod.last=angular.toJson(e))},this.sortOn=function(t,e){var a=(D.state.lastSortShifted,D.state.sortObj[e]),n=angular.isDefined(a)?!D.state.sortObj[e]:!0;t||(D.state.sortObj={},D.state.sortOrder.length=0);var o=D.state.sortOrder.indexOf(e)>-1;o||D.state.sortOrder.push(e),D.state.sortObj[e]=n,D.state.lastSortShifted=t,r.$broadcast("oTable::sorting")},this.columnFilter=function(t,e){I.propertyMap[e];D.state.searchObj[e]=t,t||delete D.state.searchObj[e],r.$broadcast("oTable::filtering")},this.getSortingPropertyInfo=function(t){return{sorting:d(t),direction:f(t)}}}]).directive("oTable",function(){return{priority:800,restrict:"EA",scope:{config:"=",state:"=",exposeApiAs:"="},controller:"oTableCtrl",controllerAs:"oTableCtrl",compile:function(){return function(t,e,a,r){r.init(t.config),t.state&&(t.state=r.state),a.exposeApiAs&&(t.exposeApiAs=r.api),e.addClass("o-table")}}}}).directive("oTableController",function(){return{restrict:"A",priority:1e3,scope:!0,require:"^oTable",link:function(t,e,a,r){var n=a.exposeAs||"ctrl";t[n]=r}}});
