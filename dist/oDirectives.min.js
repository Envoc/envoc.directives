...
!function(){"use strict";var t=angular.module("envoc.directives.datatables");t.controller("oTableCtrl",["$scope","$http","$filter","$rootScope",function(t,e,r,a){function n(){var t=angular.copy(M);D.state.allSearch?(t=x(t,D.state.allSearch),D.state.iTotalDisplayRecords=t.length):D.state.iTotalDisplayRecords=M.length;var e=D.state.sortOrder.length>0;if(e){var r=D.state.sortOrder[0],a=D.state.sortObj[r]?"+":"-",n=a+r;t=C(t,n)}for(D.state.iTotalRecords=M.length,D.state.pageStartIdx=(D.state.currentPage-1)*D.state.linesPerPage;D.state.pageStartIdx>t.length;)D.state.currentPage--,m();D.data=j($(t,D.state.pageStartIdx),D.state.linesPerPage),v()}function o(){j=r("limitTo"),x=r("filter"),$=r("startFrom"),C=r("orderBy"),M=A.dataSrc,n(),p(),a.$on("oTable::sorting",n),a.$on("oTable::filtering",n)}function s(){S(),a.$on("oTable::filtering",D.fetch)}function i(t){return e.post(A.dataSrcUrl,t)}function l(){return A.defaultSort.map(function(t){return{ColumnIndex:t[0],SortDirection:t[1],SearchTerm:t[2]||null}})}function c(){var t=D.state,e=angular.extend({},t.searchObj,t.sortObj),r={Skip:(t.currentPage-1)*t.linesPerPage,Take:t.linesPerPage,AllSearch:t.allSearch};return r.Columns=[],angular.forEach(e,function(e,a){var n=angular.isDefined(t.sortObj[a])?d(a):null,o=t.searchObj[a]||null,s=A.propertyMap[a];(n||o)&&r.Columns.push({ColumnIndex:s,SortDirection:n,SearchTerm:o})}),A.defaultSort.length&&!D.state.sortOrder.length&&(r.Columns=Array.prototype.concat.apply(r.Columns,l())),r}function u(t){return D.state.sortOrder.indexOf(t)>-1}function d(t){var e="";return u(t)&&(e=D.state.sortObj[t]?"asc":"desc"),e}function f(t){function e(t){function e(e,r){a[e]=t[r],A.propertyMap[e]=r}var a={};return r.forEach(e),a}A.propertyMap={};var r=t.sColumns.split(","),a=t.aaData.map(e);return a}function h(t){D.data=M=f(t.data),D.state.iTotalRecords=t.data.iTotalRecords,D.state.iTotalDisplayRecords=t.data.iTotalDisplayRecords,m(),v(),D.loading=!1}function g(){alert("Error fetching data")}function p(){t.$watch(b,n),t.$watch(P,n),t.$watch(T,n),t.$watchCollection(O,n)}function S(){A.throttle>300&&(D.fetch=y(D.fetch,A.throttle)),t.$watch(c,D.fetch,!0)}function b(){return D.state.currentPage}function P(){return D.state.linesPerPage}function T(){return D.state.allSearch}function O(){return M}function m(){D.state.pageStartIdx=(D.state.currentPage-1)*D.state.linesPerPage}function v(){D.state.pageStopIdx=D.state.pageStartIdx+D.data.length}function y(t,e,r){e||(e=250);var a,n;return function(){var o=r||this,s=+new Date,i=arguments;a&&a+e>s?(clearTimeout(n),n=setTimeout(function(){a=s,t.apply(o,i)},e)):(a=s,t.apply(o,i))}}var j,x,$,C,D=this,M=[],A={fetchMethod:null,linesPerPage:10,throttle:0,defaultSort:[]};this.init=function(t){if(angular.extend(A,t),D.paginationSettings=t.paginationSettings||{},!A.dataSrcUrl&&!A.dataSrc&&!A.fetchMethod)throw new Error("A data source is required");A.dataSrcUrl&&(A.fetchMethod=i),this.state={currentPage:1,linesPerPage:A.linesPerPage,iTotalRecords:0,iTotalDisplayRecords:0,allSearch:"",sortObj:{},sortOrder:[],searchObj:{}},A.dataSrc?o():s()},this.fetch=function(){D.loading=!0;var t=c();A.getAdditionalParams&&(t=angular.extend(t,A.getAdditionalParams())),A.fetchMethod.last&&angular.toJson(t)==A.fetchMethod.last||(A.fetchMethod(t).then(h,g),A.fetchMethod.last=angular.toJson(t))},this.sortOn=function(t,e){var r=(D.state.lastSortShifted,D.state.sortObj[e]),n=angular.isDefined(r)?!D.state.sortObj[e]:!0;t||(D.state.sortObj={},D.state.sortOrder.length=0);var o=D.state.sortOrder.indexOf(e)>-1;o||D.state.sortOrder.push(e),D.state.sortObj[e]=n,D.state.lastSortShifted=t,a.$broadcast("oTable::sorting")},this.columnFilter=function(t,e){A.propertyMap[e];D.state.searchObj[e]=t,t||delete D.state.searchObj[e],a.$broadcast("oTable::filtering")},this.getSortingPropertyInfo=function(t){return{sorting:u(t),direction:d(t)}}}]),t.directive("oTable",function(){return{priority:800,restrict:"EA",scope:{config:"=",state:"="},controller:"oTableCtrl",controllerAs:"oTableCtrl",compile:function(){return function(t,e,r,a){a.init(t.config),t.state&&(t.state=a.state),e.addClass("o-table")}}}}),t.directive("oTableController",function(){return{restrict:"A",priority:1e3,scope:!0,require:"^oTable",link:function(t,e,r,a){var n=r.exposeAs||"ctrl";t[n]=a}}})}();
