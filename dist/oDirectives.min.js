...
!function(){"use strict";var t=angular.module("envoc.directives.datatables");t.controller("oTableCtrl",["$scope","$http","$filter","$rootScope",function(t,e,a,r){function n(){var t=angular.copy(C);M.state.allSearch?(t=j(t,M.state.allSearch),M.state.iTotalDisplayRecords=t.length):M.state.iTotalDisplayRecords=C.length;var e=M.state.sortOrder.length>0;if(e){var a=M.state.sortOrder[0],r=M.state.sortObj[a]?"+":"-",n=r+a;t=x(t,n)}for(M.state.iTotalRecords=C.length,M.state.pageStartIdx=(M.state.currentPage-1)*M.state.linesPerPage;M.state.pageStartIdx>t.length;)M.state.currentPage--,O();M.data=y($(t,M.state.pageStartIdx),M.state.linesPerPage),v()}function o(){y=a("limitTo"),j=a("filter"),$=a("startFrom"),x=a("orderBy"),C=D.dataSrc,n(),g(),r.$on("oTable::sorting",n),r.$on("oTable::filtering",n)}function s(){p(),r.$on("oTable::filtering",M.fetch)}function i(){return e.post(D.dataSrcUrl,l())}function l(){var t=M.state,e=angular.extend({},t.searchObj,t.sortObj),a={Skip:(t.currentPage-1)*t.linesPerPage,Take:t.linesPerPage,AllSearch:t.allSearch};return a.Columns=[],angular.forEach(e,function(e,r){var n=angular.isDefined(t.sortObj[r])?u(r):null,o=t.searchObj[r]||null,s=D.propertyMap[r];(n||o)&&a.Columns.push({ColumnIndex:s,SortDirection:n,SearchTerm:o})}),a}function c(t){return M.state.sortOrder.indexOf(t)>-1}function u(t){var e="";return c(t)&&(e=M.state.sortObj[t]?"asc":"desc"),e}function d(t){function e(t){function e(e,a){r[e]=t[a],D.propertyMap[e]=a}var r={};return a.forEach(e),r}D.propertyMap={};var a=t.sColumns.split(","),r=t.aaData.map(e);return r}function f(t){M.data=C=d(t.data),M.state.iTotalRecords=t.data.iTotalRecords,M.state.iTotalDisplayRecords=t.data.iTotalDisplayRecords,O(),v(),M.loading=!1}function h(){alert("Error fetching data")}function g(){t.$watch(b,n),t.$watch(S,n),t.$watch(P,n),t.$watchCollection(T,n)}function p(){D.throttle>300&&(M.fetch=m(M.fetch,D.throttle)),t.$watch(l,M.fetch,!0)}function b(){return M.state.currentPage}function S(){return M.state.linesPerPage}function P(){return M.state.allSearch}function T(){return C}function O(){M.state.pageStartIdx=(M.state.currentPage-1)*M.state.linesPerPage}function v(){M.state.pageStopIdx=M.state.pageStartIdx+M.data.length}function m(t,e,a){e||(e=250);var r,n;return function(){var o=a||this,s=+new Date,i=arguments;r&&r+e>s?(clearTimeout(n),n=setTimeout(function(){r=s,t.apply(o,i)},e)):(r=s,t.apply(o,i))}}var y,j,$,x,M=this,C=[],D={fetchMethod:null,linesPerPage:10,throttle:0};this.init=function(t){if(angular.extend(D,t),M.paginationSettings=t.paginationSettings||{},!D.dataSrcUrl&&!D.dataSrc&&!D.fetchMethod)throw new Error("A data source is required");D.dataSrcUrl&&(D.fetchMethod=i),this.state={currentPage:1,linesPerPage:D.linesPerPage,iTotalRecords:0,iTotalDisplayRecords:0,allSearch:"",sortObj:{},sortOrder:[],searchObj:{}},D.dataSrc?o():s()},this.fetch=function(){M.loading=!0;var t=l();D.getAdditionalParams&&(t=angular.extend(t,D.getAdditionalParams())),D.fetchMethod.last&&angular.toJson(t)==D.fetchMethod.last||(D.fetchMethod(t).then(f,h),D.fetchMethod.last=angular.toJson(t))},this.sortOn=function(t,e){var a=(M.state.lastSortShifted,M.state.sortObj[e]),n=angular.isDefined(a)?!M.state.sortObj[e]:!0;t||(M.state.sortObj={},M.state.sortOrder.length=0);var o=M.state.sortOrder.indexOf(e)>-1;o||M.state.sortOrder.push(e),M.state.sortObj[e]=n,M.state.lastSortShifted=t,r.$broadcast("oTable::sorting")},this.columnFilter=function(t,e){D.propertyMap[e];M.state.searchObj[e]=t,t||delete M.state.searchObj[e],r.$broadcast("oTable::filtering")},this.getSortingPropertyInfo=function(t){return{sorting:c(t),direction:u(t)}}}]),t.directive("oTable",function(){return{priority:800,restrict:"EA",scope:{config:"=",state:"="},controller:"oTableCtrl",controllerAs:"oTableCtrl",compile:function(){return function(t,e,a,r){r.init(t.config),t.state&&(t.state=r.state),e.addClass("o-table")}}}}),t.directive("oTableController",function(){return{restrict:"A",priority:1e3,scope:!0,require:"^oTable",link:function(t,e,a,r){var n=a.exposeAs||"ctrl";t[n]=r}}})}();
