...
!function(){"use strict";var t=angular.module("envoc.directives.datatables");t.controller("oTableCtrl",function(t,e,a,r){function n(){var t=angular.copy($);C.state.allSearch?(t=j(t,C.state.allSearch),C.state.iTotalDisplayRecords=t.length):C.state.iTotalDisplayRecords=$.length;var e=C.state.sortOrder.length>0;if(e){var a=C.state.sortOrder[0],r=C.state.sortObj[a]?"+":"-",n=r+a;t=M(t,n)}for(C.state.iTotalRecords=$.length,C.state.pageStartIdx=(C.state.currentPage-1)*C.state.linesPerPage;C.state.pageStartIdx>t.length;)C.state.currentPage--,O();C.data=y(x(t,C.state.pageStartIdx),C.state.linesPerPage),v()}function o(){y=a("limitTo"),j=a("filter"),x=a("startFrom"),M=a("orderBy"),$=R.dataSrc,n(),g(),r.$on("oTable::sorting",n),r.$on("oTable::filtering",n)}function s(){p(),r.$on("oTable::filtering",C.fetch)}function i(){return e.post(R.dataSrcUrl,l())}function l(){var t=C.state,e=angular.extend({},t.searchObj,t.sortObj),a={Skip:(t.currentPage-1)*t.linesPerPage,Take:t.linesPerPage,AllSearch:t.allSearch};return a.Columns=[],angular.forEach(e,function(e,r){var n=t.sortObj[r]?u(r):null,o=t.searchObj[r]||null,s=R.propertyMap[r];(n||o)&&a.Columns.push({ColumnIndex:s,SortDirection:n,SearchTerm:o})}),a}function c(t){return C.state.sortOrder.indexOf(t)>-1}function u(t){var e="";return c(t)&&(e=C.state.sortObj[t]?"asc":"desc"),e}function d(t){function e(t){function e(e,a){r[e]=t[a],R.propertyMap[e]=a}var r={};return a.forEach(e),r}R.propertyMap={};var a=t.sColumns.split(","),r=t.aaData.map(e);return r}function f(t){C.data=$=d(t.data),C.state.iTotalRecords=t.data.iTotalRecords,C.state.iTotalDisplayRecords=t.data.iTotalDisplayRecords,O(),v()}function h(){alert("Error fetching data")}function g(){t.$watch(b,n),t.$watch(S,n),t.$watch(P,n),t.$watchCollection(T,n)}function p(){R.throttle>300&&(C.fetch=m(C.fetch,R.throttle)),t.$watch(l,C.fetch,!0)}function b(){return C.state.currentPage}function S(){return C.state.linesPerPage}function P(){return C.state.allSearch}function T(){return $}function O(){C.state.pageStartIdx=(C.state.currentPage-1)*C.state.linesPerPage}function v(){C.state.pageStopIdx=C.state.pageStartIdx+C.data.length}function m(t,e,a){e||(e=250);var r,n;return function(){var o=a||this,s=+new Date,i=arguments;r&&r+e>s?(clearTimeout(n),n=setTimeout(function(){r=s,t.apply(o,i)},e)):(r=s,t.apply(o,i))}}var y,j,x,M,C=this,$=[],R={fetchMethod:null,linesPerPage:10,throttle:0};this.init=function(t){if(angular.extend(R,t),C.paginationSettings=t.paginationSettings||{},!R.dataSrcUrl&&!R.dataSrc&&!R.fetchMethod)throw new Error("A data source is required");R.dataSrcUrl&&(R.fetchMethod=i),this.state={currentPage:1,linesPerPage:R.linesPerPage,iTotalRecords:0,iTotalDisplayRecords:0,allSearch:"",sortObj:{},sortOrder:[],searchObj:{}},R.dataSrc?o():s()},this.fetch=function(){var t=l();R.getAdditionalParams&&(t=angular.extend(t,R.getAdditionalParams())),R.fetchMethod.last&&angular.toJson(t)==R.fetchMethod.last||(R.fetchMethod(t).then(f,h),R.fetchMethod.last=angular.toJson(t))},this.sortOn=function(t,e){var a=C.state.lastSortShifted,n=C.state.sortObj[e],o=a&&!t?!0:!n;t||(C.state.sortObj={},C.state.sortOrder.length=0);var s=C.state.sortOrder.indexOf(e)>-1;s||C.state.sortOrder.push(e),C.state.sortObj[e]=o,C.state.lastSortShifted=t,r.$broadcast("oTable::sorting")},this.columnFilter=function(t,e){R.propertyMap[e];C.state.searchObj[e]=t,t||delete C.state.searchObj[e],r.$broadcast("oTable::filtering")},this.getSortingPropertyInfo=function(t){return{sorting:c(t),direction:u(t)}}}),t.directive("oTable",function(){return{priority:800,restrict:"EA",scope:{config:"=",state:"="},controller:"oTableCtrl",controllerAs:"oTableCtrl",compile:function(){return function(t,e,a,r){r.init(t.config),t.state&&(t.state=r.state),e.addClass("o-table")}}}}),t.directive("oTableController",function(){return{restrict:"A",priority:1e3,scope:!0,require:"^oTable",link:function(t,e,a,r){var n=a.exposeAs||"ctrl";t[n]=r}}})}();
