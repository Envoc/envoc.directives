...
!function(){"use strict";var t=angular.module("envoc.directives.datatables");t.controller("oTableCtrl",["$scope","$http","$filter","$rootScope","$timeout",function(t,e,r,a,n){function o(){var t=angular.copy(A);M.state.allSearch?(t=x(t,M.state.allSearch),M.state.iTotalDisplayRecords=t.length):M.state.iTotalDisplayRecords=A.length;var e=M.state.sortOrder.length>0;if(e){var r=M.state.sortOrder[0],a=M.state.sortObj[r]?"+":"-",n=a+r;t=D(t,n)}for(M.state.iTotalRecords=A.length,M.state.pageStartIdx=(M.state.currentPage-1)*M.state.linesPerPage;M.state.pageStartIdx>t.length;)M.state.currentPage--,v();M.data=j(C(t,M.state.pageStartIdx),M.state.linesPerPage),y()}function s(){j=r("limitTo"),x=r("filter"),C=r("startFrom"),D=r("orderBy"),A=I.dataSrc,o(),S(),a.$on("oTable::sorting",o),a.$on("oTable::filtering",o)}function i(){b(),a.$on("oTable::filtering",M.fetch)}function l(t){return e.post(I.dataSrcUrl,t)}function c(){return I.defaultSort.map(function(t){return{ColumnIndex:t[0],SortDirection:t[1],SearchTerm:t[2]||null}})}function u(){var t=M.state,e=angular.extend({},t.searchObj,t.sortObj),r={Skip:(t.currentPage-1)*t.linesPerPage,Take:t.linesPerPage,AllSearch:t.allSearch};return r.Columns=[],angular.forEach(e,function(e,a){var n=angular.isDefined(t.sortObj[a])?f(a):null,o=t.searchObj[a]||null,s=I.propertyMap[a];(n||o)&&r.Columns.push({ColumnIndex:s,SortDirection:n,SearchTerm:o})}),I.defaultSort.length&&!M.state.sortOrder.length&&(r.Columns=Array.prototype.concat.apply(r.Columns,c())),r}function d(t){return M.state.sortOrder.indexOf(t)>-1}function f(t){var e="";return d(t)&&(e=M.state.sortObj[t]?"asc":"desc"),e}function h(t){function e(t){function e(e,r){a[e]=t[r],I.propertyMap[e]=r}var a={};return r.forEach(e),a}I.propertyMap={};var r=t.sColumns.split(","),a=t.aaData.map(e);return a}function g(t){M.data=A=h(t.data),M.state.iTotalRecords=t.data.iTotalRecords,M.state.iTotalDisplayRecords=t.data.iTotalDisplayRecords,v(),y(),M.loading=!1}function p(){alert("Error fetching data")}function S(){t.$watch(P,o),t.$watch(T,o),t.$watch(O,o),t.$watchCollection(m,o)}function b(){I.throttle>300&&(M.fetch=$(M.fetch,I.throttle)),t.$watch(u,M.fetch,!0)}function P(){return M.state.currentPage}function T(){return M.state.linesPerPage}function O(){return M.state.allSearch}function m(){return A}function v(){M.state.pageStartIdx=(M.state.currentPage-1)*M.state.linesPerPage}function y(){M.state.pageStopIdx=M.state.pageStartIdx+M.data.length}function $(t,e,r){e||(e=250);var a,n;return function(){var o=r||this,s=+new Date,i=arguments;a&&a+e>s?(clearTimeout(n),n=setTimeout(function(){a=s,t.apply(o,i)},e)):(a=s,t.apply(o,i))}}var j,x,C,D,M=this,A=[],I={fetchMethod:null,linesPerPage:10,throttle:0,defaultSort:[]};this.init=function(t){if(angular.extend(I,t),M.paginationSettings=t.paginationSettings||{},!I.dataSrcUrl&&!I.dataSrc&&!I.fetchMethod)throw new Error("A data source is required");I.dataSrcUrl&&(I.fetchMethod=l),this.state={currentPage:1,linesPerPage:I.linesPerPage,iTotalRecords:0,iTotalDisplayRecords:0,allSearch:"",sortObj:{},sortOrder:[],searchObj:{}},I.dataSrc?s():i()},this.fetch=function(){var t=u();I.getAdditionalParams&&(t=angular.extend(t,I.getAdditionalParams())),I.fetchMethod.last&&angular.toJson(t)==I.fetchMethod.last||(M.loading=null,n(function(){null==M.loading&&(M.loading=!0)},500),I.fetchMethod(t).then(g,p),I.fetchMethod.last=angular.toJson(t))},this.sortOn=function(t,e){var r=(M.state.lastSortShifted,M.state.sortObj[e]),n=angular.isDefined(r)?!M.state.sortObj[e]:!0;t||(M.state.sortObj={},M.state.sortOrder.length=0);var o=M.state.sortOrder.indexOf(e)>-1;o||M.state.sortOrder.push(e),M.state.sortObj[e]=n,M.state.lastSortShifted=t,a.$broadcast("oTable::sorting")},this.columnFilter=function(t,e){I.propertyMap[e];M.state.searchObj[e]=t,t||delete M.state.searchObj[e],a.$broadcast("oTable::filtering")},this.getSortingPropertyInfo=function(t){return{sorting:d(t),direction:f(t)}}}]),t.directive("oTable",function(){return{priority:800,restrict:"EA",scope:{config:"=",state:"="},controller:"oTableCtrl",controllerAs:"oTableCtrl",compile:function(){return function(t,e,r,a){a.init(t.config),t.state&&(t.state=a.state),e.addClass("o-table")}}}}),t.directive("oTableController",function(){return{restrict:"A",priority:1e3,scope:!0,require:"^oTable",link:function(t,e,r,a){var n=r.exposeAs||"ctrl";t[n]=a}}})}();
